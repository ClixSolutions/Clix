...
<div class="g_4 contents_header">
    <h3 class="i_16_dashboard tab_label">Calls List</h3>
    <div><span class="label">View List of Calls and Charges</span></div>
</div>
<div class="g_8 contents_options">
    <div class="simple_buttons">
            <input type="text" class="simple_field pick_date" placeholder="End Date...">
    </div>
    <div class="simple_buttons">
        <input type="text" class="simple_field pick_date" placeholder="Start Date...">
    </div>
</div>
...
<!-- Quick Statistics -->
<div class="g_6 quick_stats">
    <div class="big_stats visitor_stats">
        9827
    </div>
    <h5 class="stats_info">Calls Made</h5>
</div>
<div class="g_6 quick_stats">
    <div class="big_stats tickets_stats">
        &pound;90,999.99
    </div>
    <h5 class="stats_info">Total Cost</h5>
</div>
