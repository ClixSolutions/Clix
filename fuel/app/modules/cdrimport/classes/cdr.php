        ...
        foreach ($allData as $data)
        {
            ...
            if ($recordNumber > 1)
            {
                Model_Cdr::Add_CDR_Record(array(
                    ...
                    'number_presented' => (isset($data['Number presented'])) ? $data['Number presented'] : $data['Number presented in'],
                    'number_dialled'   => (isset($data['Number dialled'])) ? $data['Number dialled'] : $data['Number dialled out'],
                    'prefix'           => $data['Prefix'],
